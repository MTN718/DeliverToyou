$(function () {
    ...
    /* Fix radio css issue with Jquery Mobile */
    $('.form-wizard').on('click', 'label.ui-btn', function(){
        var radio_name = $(this).next().attr('name');
        if($(this).hasClass('ui-radio-off')) {
            $('input[name="'+radio_name+'"]').prev().removeClass('ui-radio-on').addClass('ui-radio-off');
            $('input[name="'+radio_name+'"]').data('cacheval' , 'true');
            $(this).removeClass('ui-radio-off').addClass('ui-radio-on');
            $(this).next().data('cacheval' , 'false');
        }
        else{
            $('input[name="'+radio_name+'"]').prev().removeClass('ui-radio-off').addClass('ui-radio-on');
            $('input[name="'+radio_name+'"]').data('cacheval' , 'false');
            $(this).removeClass('ui-radio-on').addClass('ui-radio-off');
            $(this).next().data('cacheval' , 'true');
        }
    });
